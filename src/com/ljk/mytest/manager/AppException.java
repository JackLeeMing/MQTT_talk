...
public class AppException extends Exception implements UncaughtExceptionHandler{
	...
	public final static byte TYPE_FILE		= 0x0a;
	public final static byte TYPE_URL		= 0x0b;
	...
	public void makeToast(Context ctx){
		...
		case TYPE_JSON:
			...
			break;
		case TYPE_URL:
			Toast.makeText(ctx, String.format("%s:%s", "url解析异常", getMessage().split(":")[1]), Toast.LENGTH_SHORT);
			break;
	...
	public void saveErrorLog(Exception excp) {
		...
		try {
			...
			if(storageState.equals(Environment.MEDIA_MOUNTED)){
				savePath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/smartbow/Log/";
	...
	public static AppException url(Exception e) {
